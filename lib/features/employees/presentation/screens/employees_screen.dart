...
class EmployeesScreen extends ConsumerWidget {
              ...
              data: (List<UserModel> employees) {
                ...
                return ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return EmployeeCard(
                      employee: employee,
                      onEdit: () => _showNotImplementedSnackBar(context, 'Edición'),
                      onToggleActive: () => _showNotImplementedSnackBar(
                        context,
                        employee.isActive ? 'Desactivación' : 'Activación',
                      ),
                      onHistory: () => _showNotImplementedSnackBar(context, 'Historial'),
                    );
                  },
                );
              },
        ...
        children: [
          ...
          ElevatedButton.icon(
            onPressed: () {
              ...
              ref.read(employeeFilterProvider.notifier).setFilter(EmployeeStatusFilter.all);
            },
  ...
  void _showNotImplementedSnackBar(BuildContext context, String action) {
    ScaffoldMessenger.of(context).clearSnackBars();
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('$action próximamente disponible (TASK-002).'),
